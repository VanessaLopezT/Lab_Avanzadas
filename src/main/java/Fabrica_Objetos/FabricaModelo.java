...
public class FabricaModelo {
    ...
    public static InscripcionesPersona crearInscripcionesPersona() {
        return new InscripcionesPersona();
    }
    ...
    public static CursoProfesores crearCursoProfesores() {
        return new CursoProfesores();
    }
    ...
    public static InscripcionApp crearInscripcionApp() {
        return new InscripcionApp();
    }

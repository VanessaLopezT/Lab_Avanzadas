...
public class InscripcionesPersonaDAO {
    ...
    public List<Persona> obtenerTodasLasInscripciones() {
        ...
        Connection conexion = DatabaseConnection.getInstance().getConnection();
            ...
            while (rs.next()) {
                listado.add(FabricaModelo.crearPersona(
                    rs.getInt("persona_id"),
                    rs.getString("nombres"),
                    rs.getString("apellidos"),
                    rs.getString("email")
    ...
    try (
        ...
        while (rs.next()) {
            ...
            Persona persona = FabricaModelo.crearPersona(
                rs.getInt("persona_id"),
                rs.getString("nombres"),
                rs.getString("apellidos"),
                rs.getString("email")
    ...
    try (FileOutputStream archivo = new FileOutputStream("personas.bin");
        ...
        System.out.print("\nguardainformacion --> Lista de Persona añadida con exito en archivo binario.");
